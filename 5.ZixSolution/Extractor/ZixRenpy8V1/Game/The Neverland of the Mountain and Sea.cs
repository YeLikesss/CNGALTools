...
namespace Extractor.ZixRenpy8V1.Game
{
    public class TheNeverlandOfTheMountainAndSea : IKeyInformation,IRPAExtractor
    {
        public byte[] SubstitutionBox1 => new byte[]
        {
        ...
        public byte[] SubstitutionBox2 => new byte[]
        {
        ...
        public byte[] SubstitutionBox3 => new byte[]
        {
        ...
        public byte[] SubstitutionBox4 => new byte[]
        {
        ...
        public byte[] SubstitutionBox5 => new byte[]
        {
        ...
        public byte[] SubstitutionBox6 => new byte[]
        {
        ...
        public byte[] SubstitutionBox7 => new byte[]
        {
        ...
        public byte[] SubstitutionBox8 => new byte[]
        {
        ...
        public byte[] MainKey => new byte[]
        {
            0x24, 0x19, 0xF8, 0x38, 0x6D, 0xF8, 0xDC, 0x53, 
            0x0B, 0x52, 0x6A, 0x70, 0xC3, 0x0C, 0x3A, 0x73
        };
