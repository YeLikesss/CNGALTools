...
namespace Extractor.ZixRenpy8V1.Game
{
    ...
    /// 山的桃源乡 海的乌托邦
    /// </summary>
    public class TheNeverlandOfTheMountainAndSea : KeyInformationBase, IRPAExtractor
    {
    ...
    ///  夏空的蒲公英
    /// </summary>
    public class DandelionsInTheSky : KeyInformationBase, IRPAExtractor
    {
        public void Extract(string filePath, string extractPath)
        {
            string extractDir = Path.Combine(extractPath, Path.GetFileNameWithoutExtension(filePath));
    ...
    /// 忆夏之铃
    /// </summary>
    public class SummerMemoryOfBell : KeyInformationBase, IRPAExtractor
    {
        public void Extract(string filePath, string extractPath)
        {
            string extractDir = Path.Combine(extractPath, Path.GetFileNameWithoutExtension(filePath));
